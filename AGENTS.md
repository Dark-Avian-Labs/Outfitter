...
Add-gear accepts Ctrl+V of a Watcher of Realms gear screenshot. OCR only fills stat types and values (`server/ocr/`, local `eng.traineddata`). Slot, set, prefix, and exclusives stay manual.
